# 🚀 Quick Start Prompt for GitHub Codespace

**Copy and paste this entire prompt into your GitHub Codespace terminal to set up the BuildRight Solutions Quotation Agent:**

```bash
# =============================================
# BUILD RIGHT SOLUTIONS - QUOTATION AGENT SETUP
# =============================================

# 1. Create setup script
cat > setup_quotation_agent.sh << 'EOF_SETUP'
#!/bin/bash
